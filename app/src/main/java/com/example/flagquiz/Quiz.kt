...
class Quiz: Thread
{
    ...
    constructor(duration : Long,noFlags : Int)
    {
    ...
    override public fun run() {
        ...
        do {
            var handler1 = QuizHandler(files[count % files.size],"what flag is this?")
            MainActivity.getInstance().runOnUiThread(handler1)
            sleep(3000) //Delay
            var handler = QuizHandler(files[count % files.size],countries[count % countries.size])
    ...
    class QuizHandler : Runnable
    {
        ...
        {
            this.fn=fn //File name of the image to be displayed by the ImageView
            this.text=text //Text to be displayed by the TextView
        }

        override public fun run()
        {
            var imageView = MainActivity.getInstance().findViewById<ImageView>(R.id.imageView)
            var textView = MainActivity.getInstance().findViewById<TextView>(R.id.textView3)
